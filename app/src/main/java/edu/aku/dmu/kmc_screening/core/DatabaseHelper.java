package edu.aku.dmu.kmc_screening.core;
...
import edu.aku.dmu.kmc_screening.contracts.FamilyMembersContract;
import edu.aku.dmu.kmc_screening.contracts.FamilyMembersContract.familyMembers;
import edu.aku.dmu.kmc_screening.contracts.FormsContract;
import edu.aku.dmu.kmc_screening.contracts.FormsContract.FormsTable;
import edu.aku.dmu.kmc_screening.contracts.TalukasContract;
import edu.aku.dmu.kmc_screening.contracts.TalukasContract.singleTaluka;
import edu.aku.dmu.kmc_screening.contracts.UCsContract;
import edu.aku.dmu.kmc_screening.contracts.UCsContract.UCsTable;
import edu.aku.dmu.kmc_screening.contracts.UsersContract;
import edu.aku.dmu.kmc_screening.contracts.UsersContract.UsersTable;
import edu.aku.dmu.kmc_screening.contracts.VillagesContract;
import edu.aku.dmu.kmc_screening.contracts.VillagesContract.singleVillage;
